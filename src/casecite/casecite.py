...
class LegalCitationResearcher:
    def __init__(self, config: ModelParams):
        ...
        self.citation_user_prompt = """
                ...
                **Important:** Your ENTIRE response, including the JSON content, 
                MUST be enclosed within <json_output> and </json_output> tags. 
                Do not include any text outside of these tags. The JSON output between
    ...
    def extract_limitations(self, text: str) -> str:
        ...
        try:
            ...
            self.logger.exception(e)
            self.logger.error("(L) Failed to decode JSON from text: %s", json_text)

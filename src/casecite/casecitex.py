...
if __name__ == "__main__":
    ...
    model_params = ModelParams(vendor)
    ...
    if vendor == "anthropic":
        ...
        raise ValueError("Invalid LLM vendor specified in environment variables.")
    ...
    case_cite = CaseCite(llm=llm)

    # Ask for a proposition from the user
    proposition = input("Enter a legal proposition: ")
    
    # Perform multi-step legal research
    results = case_cite.multi_step_legal_research(proposition)
